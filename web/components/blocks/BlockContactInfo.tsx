...
export function BlockContactInfo({
  ...
  const address =
    useGlobalSettings && siteSettings?.address
  ...
  return (
    <section className="block-background-overlay bg-white py-20">
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-4xl">
          ...
          <div
            className={`grid ${showMap ? "lg:grid-cols-2" : "grid-cols-1"} gap-12`}
          >
            {/* Contact Details */}
            <div className="space-y-6">
              {address && (
                <div className="flex items-start gap-4">
                  <div className="bg-faect-blue/10 flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full">
                    <svg
                      className="text-faect-blue h-5 w-5"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                  ...
                  <div>
                    <h3 className="text-faect-navy mb-1 font-semibold">
                      Adres
                    </h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="hover:text-faect-blue text-gray-600 transition-colors"
                    >
                      {phone}
                    </a>
                  </div>
                ...
                <div className="flex items-center gap-4 pt-4">
                  {socialLinks.map((link) => (
                    <a
                      ...
                      className="bg-faect-navy hover:bg-faect-blue flex h-10 w-10 items-center justify-center rounded-full text-white transition-colors"
                    >
