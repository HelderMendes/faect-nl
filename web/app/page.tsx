  ...
  return (
    <main className="flex flex-col">
      ...
      <BlockPartnerLogos
        ...
        displayMode="slider"
        settings={{backgroundColor: 'white', paddingTop: 'compact', paddingBottom: 'compact'}}
        partners={[
        ...
        apps={[
          {
            ...
            excerpt: 'Automatiseer bankafschriften en verbeter je cashflow beheer.',
          },
          {
            _id: 'app2',
            title: 'WMS Solution',
      ...
      <BlockFeatureGrid
        ...
        features={[
          ...
          },
          {
            ...
            description: 'Handmatig werk verminderen door standaardisatie en automatisering.',
          },
          {
            _key: '3',
            title: 'Gebruiksvriendelijkheid',
            description: 'Een platform dat naadloos aansluit op je processen en meegroeit.',
          },
        ]}
